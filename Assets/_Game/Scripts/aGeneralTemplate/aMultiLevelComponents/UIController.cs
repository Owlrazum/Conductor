...
namespace GeneralTemplate
{
    public class UIController : MonoBehaviour
    {
        ...
        [Header("StartGameCanvas")]
        [Space]
        [SerializeField]
        private Canvas startGameCanvas;

        [SerializeField]
        private LoopedFadingText startTextFading;

        [SerializeField]
        private float rateOfFading;
        ...
        private void Start()
        {
            ...
            if (startTextFading != null)
            {
                startTextFading.StartFading(rateOfFading);
            }
        }

        public void ProcessStartGameTap()
        {
            ProcessGameStart();
